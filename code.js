...
angular
  ...
  .controller('MainController', ['$scope', function($scope) {
    ...
    dateClick: function(date) {
		...
		var easteroffset = -6; 
		var offset = easteroffset-localoffset;

		angular.element( document.querySelector( '#startDate' ) ).text(date.date); 


		var dueBase1W = new Date(date.date);
		dueBase1W.setDate(date.date.getDate() + 7);


		var easterBase1W = new Date(dueBase1W);
		easterBase1W.setHours(dueBase1W.getHours() + 18);
		easterBase1W.setMinutes(dueBase1W.getMinutes() + 34);
		angular.element( document.querySelector( '#endBase1' ) ).text(easterBase1W); 

		var dueBase2W = new Date(date.date);
		dueBase2W.setDate(date.date.getDate() + 14);
		var easterBase2W = new Date(dueBase2W);
		easterBase2W.setHours(dueBase2W.getHours() + 18);
		easterBase2W.setMinutes(dueBase2W.getMinutes() + 34);
		angular.element( document.querySelector( '#endBase2' ) ).text(easterBase2W); 
